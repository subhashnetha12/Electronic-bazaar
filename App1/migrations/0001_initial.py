# Generated by Django 4.2.21 on 2025-10-27 11:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('product_type', models.CharField(choices=[('COMPONENT', 'Component'), ('OLD LAPTOP', 'Old Laptop'), ('REFURBISHED', 'Refurbished Laptop')], default='REFURBISHED', help_text='Defines whether this is a component, old laptop, or refurbished laptop', max_length=20)),
                ('unit', models.CharField(choices=[('Pieces', 'Pieces')], default='Pieces', max_length=50)),
                ...
                ('brand_name', models.CharField(blank=True, choices=[('Dell', 'Dell'), ('Lenovo', 'Lenovo'), ('HP', 'HP'), ('Apple', 'Apple'), ('Asus', 'Asus'), ('Acer', 'Acer'), ('Other', 'Other')], max_length=50, null=True)),
                ...
                ('purchase_price', models.DecimalField(decimal_places=2, default=0, help_text='Cost price or component purchase rate', max_digits=10)),
                ('sale_price', models.DecimalField(decimal_places=2, default=0, help_text='Selling price or MRP for refurbished units', max_digits=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders_created', to='App1.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='App1.salesorder')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='App1.user')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='refurbished_batches', to='App1.product')),
            ],
        ),
        migrations.CreateModel(
            name='PurchaseOrder',
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('pending', 'Pending'), ('partial', 'Partial'), ('paid', 'Paid')], default='pending', max_length=50)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='App1.user')),
                ('vendor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='purchase_orders', to='App1.vendor')),
            ],
        ),
        migrations.CreateModel(
            name='PurchaseItem',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App1.product')),
                ('purchase_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='App1.purchaseorder')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remarks', models.TextField(blank=True, null=True)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='App1.salesorder')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoices', to='App1.salesorder')),
            ],
        ),
        migrations.CreateModel(
            name='Inventory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('refurbished_date', models.DateField(default=django.utils.timezone.now)),
                ('stock_in', models.PositiveIntegerField(default=0)),
                ('stock_out', models.PositiveIntegerField(default=0)),
                ('current_stock', models.IntegerField(default=0)),
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App1.product')),
                ('refurbished_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='daily_productions', to='App1.refurbishedproduct')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('component', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App1.component')),
                ('refurbished_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='components_used', to='App1.refurbishedproduct')),
            ],
        ),
        migrations.CreateModel(
            name='Attendance',
